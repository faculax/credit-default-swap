...
const TradeDetailModal: React.FC<TradeDetailModalProps> = ({ isOpen, trade, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-fd-darker rounded-lg shadow-fd border border-fd-border p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-fd-text border-b border-fd-border pb-2 mb-4">
            Credit Events
          </h3>
