...
jest.mock('../../services/creditEventService', () => ({ creditEventService: { getCreditEventsForTrade: jest.fn().mockResolvedValue([]), recordCreditEvent: jest.fn().mockResolvedValue({ creditEvent: { id: 'evt1', tradeId: 101, eventType: 'RESTRUCTURING', eventDate: '2025-01-01', noticeDate: '2025-01-01', settlementMethod: 'PHYSICAL', comments: '', createdAt: '2025-01-02' }, affectedTradeIds: [101] }) } }));
jest.mock('../../services/cdsTradeService', () => ({ cdsTradeService: { getTradeById: jest.fn().mockResolvedValue(mockTrade) } }));
